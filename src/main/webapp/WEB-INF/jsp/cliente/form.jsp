			...
			<fieldset>
				...
				<div class="row">
					...
					<div class="form-group col-sm-3 col-md-2">
						...
						<input type="date" name="dataNascimento" <c:if test="${operacao eq 'ALTERAR'}"> readonly </c:if> 
						class="form-control data" value="<fmt:formatDate value="${cliente.dataNascimento}" pattern="yyyy-MM-dd"/>"/>
					</div>
					
					<div class="form-group col-sm-3 col-md-2">
						<label for="cpf" class="control-label">CPF</label>
						<input type="text" <c:if test="${operacao eq 'ALTERAR'}"> readonly </c:if>
						name="cpf" value="${cliente.cpf}" placeholder="CPF" class="form-control cpf"/>
					</div>
